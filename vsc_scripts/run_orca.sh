...
if [ $# -eq 0 ] || [ "$1" = "-h" ] || [ "$1" = "--help" ]; then
    echo "Usage: INPUT"
    echo "Description: Submission script for Orca 5.0.4 in VSC."
    exit 0
fi
...
export ORCA=/apps/leuven/rocky8/skylake/2021a/software/ORCA/5.0.4-gompi-2021a-static/bin
export MPI=/apps/leuven/rocky8/skylake/2021a/software/OpenMPI/4.1.1-GCC-10.3.0
...
cp $indir/$input .
#[ -f "$indir/${input%.com}.xyz" && cp "$indir/${input%.com}.xyz" . ] 
cp $indir/*.xyz . 
